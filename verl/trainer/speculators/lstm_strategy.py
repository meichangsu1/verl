...
class LSTMStrategy(TemplateSpecDecodeStrategy):
    """LSTM strategy interface skeleton."""
    ...
    def build_draft_module(self, target_model, strategy_cfg: dict[str, Any]):
        ...
        raise NotImplementedError("Interface skeleton only: LSTM draft build logic is intentionally empty.")

    def extract_teacher_signals(self, target_view: TargetRuntimeView) -> dict[str, Any]:
        del target_view
        raise NotImplementedError("Interface skeleton only: LSTM teacher extraction logic is intentionally empty.")
    ...
    def build_draft_forward_request(
        ...
        del teacher_signals
        raise NotImplementedError("Interface skeleton only: LSTM draft forward request logic is intentionally empty.")
    ...
    def compute_draft_loss(
        ...
        raise NotImplementedError("Interface skeleton only: LSTM draft loss logic is intentionally empty.")
